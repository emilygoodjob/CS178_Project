...
train_data = pd.read_csv('/Users/zhengxuanli/Learning/24 Fall/CS 178/finalproject/CS178_Project/adult/adult.data', header=None, names=column_names, na_values=' ?')
test_data = pd.read_csv('/Users/zhengxuanli/Learning/24 Fall/CS 178/finalproject/CS178_Project/adult/adult.test', header=None, names=column_names, skiprows=1, na_values=' ?')
